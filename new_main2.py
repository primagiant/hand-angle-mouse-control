...
import pyautogui
import time  # ✅ Digunakan untuk cooldown
...
def main():
    ...
    while True:
        ...
        if results.multi_hand_landmarks:
            ...
            # ✅ Cek apakah sudah melewati cooldown sebelum eksekusi aksi
            current_time = time.time()
            if current_time - last_action_time > COOLDOWN:
                if class_name[gesture_id] == 'v_gest':
                    pass  # Tidak melakukan aksi
                ...
                last_action_time = current_time  # ✅ Update waktu terakhir aksi
